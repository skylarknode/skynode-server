...
module.exports = function(app) {
    ...
    var flags = {
        ...
        sslForAll: function(req) { // live July 13, 2014 / updated 2015-06-07 (to freely available)
    ...
    if (config.featureFlags) {
        ///_.extend(flags, config.featureFlags); //TODO:lwf
        Object.assign(flags,config.featureFlags)
    }
    var features = app.features = new Features(flags);
