...
var middleware = module.exports = {
  ...
  limitContentLength: function (app,options) {
        ...
        if (req.apiKey) {
          userModel.loadByApiKey(req.apiKey, function (err, user) {
            ...
            if (user) {
              ...
              onHeaders(res, () => delete req.session);
  ...
  protectServiceWorker: function (app,opts) {
...
function pathIsSSL(config,route) {
